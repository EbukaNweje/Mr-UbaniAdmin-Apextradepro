...
const Login = () => {
    ...
    const getAllUserData = () => {
        const url = "https://mr-ubani-back-end-apextradepro.vercel.app/api/alluserdata";
        axios
            .get(url)
            .then((response) => {
    ...
    const handleLogin = () => {
        if (
            ...
            axios
                .post(
                    "https://mr-ubani-back-end-apextradepro.vercel.app/api/adminlogin",
                    userData
                )
                .then((res) => {
                    console.log(res);
                ...
                <div className="w-[29%] phone:w-[85%] h-[76%]">
                    ...
                    <div className="w-full h-max bg-white shadow rounded py-12 px-12 flex flex-col gap-5">
                        ...
                        <div className="w-full text-center">
                            <p className="text-sm">
                                © Copyright 2024 Apextradepro All Rights
                                Reserved.
                            </p>
                        </div>
                    </div>
